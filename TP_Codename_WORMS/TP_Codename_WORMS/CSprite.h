...
//  Ate6
//
//  Created by Richer Archambault on 2014-10-16.
//  Copyright (c) 2014 Richer Archambault. All rights reserved.
//

#ifndef Ate6_CSprite_h
#define Ate6_CSprite_h
...
public:
	CSprite(SDL_Texture* _Texture, int _nbrFrame, int _nbrAnimation, int _delai, int _loop){
		m_pTexture = _Texture;
